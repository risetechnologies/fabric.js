/* build: `node build.js modules=ALL exclude=accessors,serialization,object_straightening,parser,image_filters,node no-svg-export requirejs minifier=uglifyjs` */
...
(function() {
   ...
   * @param {Function} [options.onChange] Callback; invoked on every value change
   * @param {Function} [options.onComplete] Callback; invoked when value change is completed
   * @param {Function} [options.colorEasing] Easing function. Note that this function only take two arguments
   *   (currentTime, duration). Thus the regular animation easing functions cannot be used.
   */
...
(function(global) {
  ...
  fabric.Shadow = fabric.util.createClass(/** @lends fabric.Shadow.prototype */ {
    ...
    /**
     * Constructor
     * @param {Object|String} [options] Options object with any of color, blur, offsetX, offsetY properties or string
     *   (e.g. "rgba(0,0,0,0.2) 2px 2px 10px")
...
(function () {
  ...
  fabric.StaticCanvas = fabric.util.createClass(fabric.CommonMethods, /** @lends fabric.StaticCanvas.prototype */ {
    ...
    /**
     * Indicates whether {@link fabric.Collection.add}, {@link fabric.Collection.insertAt} and
     * {@link fabric.Collection.remove},
     * {@link fabric.StaticCanvas.moveTo}, {@link fabric.StaticCanvas.clear} and many more, should also re-render
     * canvas. Disabling this option will not give a performance boost when adding/removing a lot of objects to/from
     * canvas at once since the renders are quequed and executed one per frame. Disabling is suggested anyway and
     * managing the renders of the app manually is not a big effort ( canvas.requestRenderAll() ) Left default to true
     * to do not break documentation and old app, fiddles.
     * @type Boolean
     * @default
     */
...
(function(global) {
  ...
  fabric.Object = fabric.util.createClass(fabric.CommonMethods, /** @lends fabric.Object.prototype */ {
    ...
    /**
     * Top position of an object. Note that by default it's relative to object top. You can change this by setting
    ...
    /**
     * Left position of an object. Note that by default it's relative to object left. You can change this by setting
     ...
     * <b>Backwards incompatibility note:</b> This property was used for setting globalCompositeOperation until v1.4.12
     * (use `fabric.Object#globalCompositeOperation` instead)
     * @type String
     * @default
     */
    fillRule:                 'nonzero',
...
(function() {
  ...
  fabric.util.object.extend(fabric.Object.prototype, /** @lends fabric.Object.prototype */ {
     ...
     * @param {String} controlName The name of the control. Possible values are 'tl', 'tr', 'br', 'bl', 'ml', 'mt',
     *   'mr', 'mb', 'mtr'.
...
(function(global) {
  ...
  fabric.Rect = fabric.util.createClass(fabric.Object, /** @lends fabric.Rect.prototype */ {
     ...
     * ({@link fabric.Object#hasStateChanged}) as well as for history (undo/redo) purposes
     * @type Array
     */
